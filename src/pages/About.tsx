...
const styles = `
  ...
  .about-orb { position: fixed; border-radius: 50%; filter: blur(100px); pointer-events: none; z-index: 0; }
  ...
  .about-dot-grid { position: fixed; inset: 0; z-index: 0; pointer-events: none; background-image: radial-gradient(rgba(33,150,243,0.055) 1px, transparent 1px); background-size: 36px 36px; }
  ...
  .about-eyebrow { display: inline-flex; align-items: center; gap: 8px; padding: 7px 20px; background: rgba(21,101,192,0.15); border: 1px solid rgba(33,150,243,0.35); border-radius: 100px; font-size: 13px; letter-spacing: 0.05em; color: var(--cyan-soft); margin-bottom: 36px; backdrop-filter: blur(12px); }
  ...
  .about-hero__title { font-family: 'Syne', sans-serif; font-size: clamp(3rem, 7vw, 5.5rem); font-weight: 800; line-height: 1.06; letter-spacing: -0.04em; margin-bottom: 32px; }
  .about-hero__title .solid { color: var(--white); }
  .about-hero__title .grad { background: linear-gradient(110deg, #4fc3f7 0%, #1976d2 30%, #00e5ff 65%, #81d4fa 100%); background-size: 220% auto; -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; animation: aShimmer 4.5s linear infinite; }
  ...
  .skill-card-about { background: var(--card-bg); border: 1px solid var(--border); border-radius: 16px; padding: 24px 22px; backdrop-filter: blur(16px); transition: transform 0.3s, border-color 0.3s, box-shadow 0.3s; position: relative; overflow: hidden; }
  ...
  .beyond-card { max-width: 820px; margin: 0 auto; background: var(--card-bg); border: 1px solid var(--border); border-radius: 20px; padding: 52px 48px; backdrop-filter: blur(16px); box-shadow: 0 0 60px rgba(21,101,192,0.1); }
...
const SKILLS = [
  ...
  { title: "Webflow Development",          icon: <Globe size={20} />,    c: "icon-webflow", desc: "CMS-powered Webflow sites with custom interactions, animations, and Figma-to-Webflow conversions." },
        ...
        <section className="about-hero">
          <div className="about-hero__inner">
            ...
            <div className="about-hero__body fade-up visible" style={{ transitionDelay: "0.2s" }}>
              ...
              <p>
                I build visually rich <span className="hl-cyan">Webflow</span> sites with custom interactions, CMS collections, and smooth animations, as well as <span className="hl-blue">WooCommerce</span> stores on WordPress — both as a freelancer on Fiverr — focused on <span className="hl-blue">performance</span>, <span className="hl-blue">SEO</span>, and <span className="hl-blue">user experience</span>.
              </p>
              <p>
                Beyond coding, I enjoy collaborating with designers and clients to transform ideas into functional digital solutions. I'm constantly refining my skills in <span className="hl-cyan">React.js</span>, <span className="hl-cyan">Tailwind CSS</span>, and <span className="hl-cyan">Webflow</span>, and exploring <span className="hl-blue">Figma</span> to improve design handoffs and workflow efficiency.
              </p>
            </div>
